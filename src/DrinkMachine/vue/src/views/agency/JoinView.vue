<template>
  <div class="agency_join">
    <div class="container" style="margin-top: 40px">
      <div
        data-role="panel"
        data-title-caption="대리점 가입"
      ...
      >
        ...
        <input
          ...
          type="text"
          data-role="input"
          data-prepend="<span class='mif-barcode'>대리점 가입코드</span>"
          ...
          <div class="row">
            <div class="cell">
              <input
                ...
                type="text"
                data-role="input"
                data-prepend="<span class='mif-user'>대리점 아이디</span>"
        ...
        <div class="row">
          <div class="cell">
            <input
              ...
              type="text"
              data-role="input"
              data-prepend="<span class='mif-tag'>대리점 명</span>"
        ...
        <button style="width: 100%" v-on:click="join()">
          <span class="mif-user-plus"> 대리점 가입</span>
        </button>
        <div class="space" style="height: 30px"></div>
      </div>
    </div>
  ...
  methods: {
    ...
    async join() {
      if(!this.$data.isChecked) {
        ...
        alert('6자리 대리점 가입코드를 입력해주세요.');
        return;
      }
      console.log('add');
      post("/api/join/agency", this.$data.input)
