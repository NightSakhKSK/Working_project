...
public class JwtTokenUtil {
	...
	private static final String secret = "dbxkfprtmglasowk";
    ...
    public String generateToken(String id, ROLE role) {
    	...
    	customClaims.put("ROLE", role.name());
    	return generateToken(id, customClaims);
    }
    ...
    public Boolean validateToken(String token, UserDetails userDetails) {
        ...
        log.debug("username {}, {}", username, userDetails);
